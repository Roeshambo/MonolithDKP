...
function MonDKP:DKPModes_Main()
    ...
    f.DKPModesMain.AntiSnipe:SetNumeric(true)
    ...
    f.DKPModesMain.Inflation:SetNumeric(true)
    ...
    f.DKPModesMain.MaxBid:SetNumeric(true)
    ...
    f.DKPModesMain.RollContainer.Header:SetText(L["ROLLSETTINGS"])
	    ...
	    f.DKPModesMain.RollContainer.rollMin:SetNumeric(true)
	    ...
	    f.DKPModesMain.RollContainer.rollMax:SetNumeric(true)
	    ...
	    f.DKPModesMain.RollContainer.AddMax:SetNumeric(true)

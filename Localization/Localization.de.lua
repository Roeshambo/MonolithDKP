if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    AUTOAWARDTTDESC = "Gewährt automatisch einen Boss-Kill-Bonus (DKP), wenn ein Boss getötet wird. Nur der Schlachtzugsführer wird Punkte damit verteilen.",
    ...
    DECLINELOWBIDSTTDESC = "Ablehnen Sie automatisch alle abgegebenen Gebote, wenn sie auf oder unter dem aktuellen Höchstgebot liegen.",
    ...
    DKPSETTINGS = "DKP Award Parameter",

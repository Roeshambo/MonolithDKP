if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    DECREASEDISENCHANT = "Sænk forstyrrende værdi",
    DECREASEDISENCHANTTTDESC = "Sænk disenchant-værdien efter 3 disenchants med halvdelen af ​​hver disenchant bagefter, indtil mindst 5 DKP",

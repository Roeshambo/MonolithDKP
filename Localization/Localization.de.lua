if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    CHANGELOG1            = "- Zusätzliche Optimierungen zur Reduzierung der Verzögerung von Sendungen.",
    CHANGELOG2            = "- Optimierte DKP-Anpassung, um die Ausführungszeit drastisch zu verkürzen.",
    CHANGELOG3            = "- Filter funktionieren jetzt ordnungsgemäß mit allen Listenansichten (RAID, Standby, Core usw.)",
    CHANGELOG4            = "- Filter-Dropdown zur Registerkarte DKP-Verlauf hinzugefügt, um den vollständigen DKP-Verlauf einer Person anzuzeigen.",
    CHANGELOG5            = "- Der Befehl! Dkp, der den Benutzer nicht richtig suchte, als gerade! Dkp gesendet wurde, wurde behoben.",
    CHANGELOG6            = "- Standby Opt In Option zum DKP Modes Fenster hinzugefügt. Wenn er aktiv ist, wird der Schlachtzugsleiter nach dem Tod eines Chefs der Gilde mitteilen, dass jeder, der nicht am Schlachtzug teilnimmt, 2 Minuten Zeit hat, sich als Standby-Spieler zu entscheiden. Spieler, die nicht am Schlachtzug teilnehmen, können sich im GUILD-Chat mit! Standby (oder! Standby NAME, wenn sie sich in einem ALT befinden) anmelden. Diese Standby-Liste wird bei jedem Boss-Kill gelöscht. Hiermit werden nur diejenigen im Standby-Modus ausgezeichnet, die derzeit aktiv sind.",
    CHANGELOG7            = "- Auto Award DKP Option zum DKP Modes Fenster hinzugefügt. Dies vergibt automatisch den gesamten Schlachtzug (und Standby, falls im selben Modusfenster ausgewählt). Boss Kill DKP, sobald ein Boss getötet wird. Wenn Standby-Opt-In aktiv ist, wird der Raid sofort vergeben, und die auf der Standby-Liste befindlichen Raids werden nach Ablauf des 2-minütigen Opt-In-Fensters nach jedem Boss vergeben. NUR der Schlachtzugsführer verteilt Punkte. Wenn der Schlachtzugsführer dieses Addon nicht hat, werden keine Punkte verteilt. Dies soll verhindern, dass mehrere Offiziere den Bonus anwenden.",
    CHANGELOG8            = "",
    CHANGELOG9            = "",
    CHANGELOG10           = "",
  }

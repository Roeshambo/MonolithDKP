if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    CommDKPSCALESIZETTDESC = "Maßstab des Monolith DKP-Fensters. Klicken Sie auf \"Save Settings\" (Einstellungen speichern), um die Größe auf den eingestellten Wert zu ändern.",

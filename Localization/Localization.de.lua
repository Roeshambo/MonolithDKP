if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    ANNOUNCEBIDTTDESC = "Jedes Mal, wenn ein neuer Bieter das höchste Gebot abgibt, müssen Sie dieses neue Höchstgebot überfallen",
    ...
    HOURS = "Std",
    IN = "im",
    INCLUDENAME = "Bieter einbeziehen",
    ...
    LOADED = "Geladen",
    LOGBIDS = "Gebote / Rollen protokollieren",
    ...
    NEWHIGHROLLER = "Neue höchste Walze ist",
    NO = "Nein",
    ...
    ROLLDECLINED = "Roll lehnte ab. Voraussichtlicher Rollbereich ist",
    ...
    CHANGELOG5            = "- Broadcasting-Einträge während des Überfalls werden weiterhin sofort gesendet, wie sie in 2.0 waren. Es wird nicht darauf gewartet, dass Einträge gesendet werden, weil Sie befürchten, Daten zu überschreiben.",

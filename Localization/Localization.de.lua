if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    CLICKQUERYGUILD = "Klicken Sie auf Broadcast-Benutzeroberfläche starten. Dadurch werden auch Informationen zu Spezialisierung und Rolle von allen Online-Spielern abgerufen.",
    CLOAK = "Mantel",
    CLOSE = "Schließen",
    ...
    BROADCASTWHICHDATA    = "Bitte wählen Sie aus, welche Daten Sie senden möchten.",
    REPAIRCOMP            = "Reparatur abgeschlossen",
    REPAIRSTART           = "Reparieren Sie Ihre Tabellen, um doppelte oder ungültige Einträge zu entfernen.",
    MISSINGENT            = "Sie vermissen einen oder mehrere Einträge der folgenden Offiziere",
    CREATED               = "Erstellt",
    BROADCASTTABLES       = "Broadcast-Tabellen",
    BCASTINGTABLES        = "Sendetabellen ...",
    FULLBROADCAST         = "Vollständige Sendung",
    MERGE2WEEKS           = "Letzte 2 Wochen zusammenführen",
    MERGE2WEEKSTTDESC     = "Überträgt die Daten der letzten zwei Wochen und wendet nur die fehlenden Einträge an.",
    MERGE2WEEKSTTWARN     = "Nützlich zum Zusammenführen von Tabellen mit anderen Schlachtzugsführern.",
    FULLBROADCASTTTDESC   = "Überträgt alle Tabellen an die oben angegebene Auswahl und überschreibt ihre Daten mit identischen Kopien Ihrer eigenen.",
    FULLBROADCASTTTWARN   = "Wenn die empfangende Partei Schlachtzugsdaten hat, die Sie nicht haben, gehen diese verloren.",
    TOPLAYERTTDESC        = "Flüstert unter Auswahl zu einzelnen Spielern.",
    TOGUILDTTDESC         = "Broadcasts unter Auswahl an die gesamte Gilde.",

    NEWERTABS1            = "Es scheint, dass %s versucht, Ihnen möglicherweise veraltete Tabellen zu senden. Neuester Eintrag in diesen Tabellen:",
    NEWERTABS2            = "Ihr aktueller Verlauf enthält neuere Einträge, die in dieser Übertragung nicht vorhanden sind. Durch das Akzeptieren werden Ihre Daten überschrieben. Willst du weiter machen?",
    OVERWRITETABLES       = "Bei einer vollständigen Übertragung werden alle Daten des Empfängers mit Ihren genauen Duplikaten überschrieben. Wenn sie Daten haben, die Sie nicht haben, werden sie überschrieben. Wenn Sie einfach Daten senden möchten, die fehlen, verwenden Sie die Option \"Letzte 2 Wochen zusammenführen\". Möchten Sie fortfahren?",
    VALIDATEWARN          = "Dadurch werden alle Spieler-DKPs, Lebenspunkte und Lebenspunkte basierend auf ihrer vollständigen Historie neu berechnet. Stellen Sie sicher, dass Sie Ihre gespeicherte Variablendatei sichern, falls das Ergebnis aufgrund fehlender Verlaufseinträge nicht korrekt ist. Sie sollten das vorherige dkp (Kontextmenü> Alles auswählen> Vorheriges dkp zurücksetzen) für alle Spieler vor dem Ausführen zurücksetzen, damit Sie sehen können, wie stark sie sich geändert haben. Willst du weiter machen?",

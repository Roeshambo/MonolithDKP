if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    NOOFFICERSONLINE      = "Derzeit sind keine Beauftragten online, mit denen synchronisiert werden kann.",
    ...
    CHANGEDGUILDS         = "Anscheinend bist du einer neuen Gilde beigetreten. Möchten Sie Ihre DKP-Tabellen löschen? Nichtbereinigung kann zu ernsthaften Problemen führen.",

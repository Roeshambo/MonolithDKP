if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    BELT = "Gürtel",
    BESTPRACTICES = "Alle Spieler müssen 2.0.3 oder höher ausführen. Ältere Versionen sind nicht kompatibel und empfangen keine Daten. Wenn Sie kein Offizier sind und eine Aktualisierung von 1.6 durchführen, werden alle Tabellen gelöscht. Sie erhalten eine Synchronisierung von einem Mitarbeiter, der den Migrationsprozess abgeschlossen hat.",

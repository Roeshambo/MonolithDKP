if GetLocale() == "deDE" then
  ...
  core.L = {
    ...
    ChangeLog3            = "- Das Abfragen des Tabellenstatus (Klicken auf die Statusanzeige unten links) gibt auch die Spezifikation jedes Spielers zur Verwendung mit der Dropdown-Liste Spezifikation zurück. Jeder Spieler muss Version 1.5.2 oder höher haben, damit es funktioniert.",
    ChangeLog4            = "- Eingeschlossene Zeile in der Abfrage, in der angezeigt wird, wie viele Spieler in der Gilde das Addon verwenden (Für Offiziere angezeigt).",
    ChangeLog5            = "- Behobener Fehler, bei dem Todesfälle von Spielern mit Mob-Kills protokolliert wurden, um sie im Dropdown-Menü zur Bestätigung der Auszeichnung zu verwenden.",
    ChangeLog6            = "- Die Schaltflächen für die manuelle Übertragung auf der Registerkarte Verwalten wurden zu einer Schaltfläche zusammengefasst. Außerdem wurde verhindert, dass Änderungen während der Übertragung vorgenommen werden, da dies ein oder zwei Minuten dauern kann, wenn Sie große Verlaufstabellen haben und dies zu einem Übersprechen führen würde, das Ihre Tabellen beschädigt. Das Erzwingen eines Broadcasts aller Tabellen zusammen verringert oder eliminiert die Möglichkeit, dass Einträge verloren gehen. Sie werden nach Abschluss der Übertragung mit einer Bestätigung aufgefordert. Während einer Übertragung keine Zonen oder Protokolle erstellen.",
    ChangeLog7            = "- Fehler beim Wechsel von View Raid zu View All behoben",
    ChangeLog8            = "- Neu geschriebener Prozess zum Senden der Löschung von Einträgen aus der DKP-Historie und der Beutehistorie. Dies sollte hoffentlich das Auftreten mysteriös verschwindender Elemente reduzieren.",
    ChangeLog9            = "- Korrektur eines Bugs beim Bieten von Rollen, wenn jemand, der nicht auf der DKP-Liste stand, versuchte, zu rollen",
    ChangeLog10           = "",
  }
end
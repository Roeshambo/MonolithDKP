if GetLocale() == "zhTW" then
  ...
  core.L = {
    ...
    ChangeLog1            = "- 在主GUI中添加了搜索框。搜索並返回按名稱，類別，規格，等級和角色找到的結果。",
    ChangeLog2            = "- 該表現在可以按規格及其他排序。",
    ChangeLog3            = "- 改進的shift / ctrl單擊功能可提供更多功能和更自然的感覺。 Shift + Click現在將在您的上一個選擇和新選擇之間進行選擇。 Ctrl / Cmd + Click將包含單個選擇，而不會刪除先前的選擇。",
    ChangeLog4            = "- 如果其中一名警官重新裝彈或墜毀，突襲計時器現在將嘗試與沒有計時器運行的警官進行同步。僅在團隊中有一名或多名其他人員進行廣播時才能工作。",
    ChangeLog5            = "- 突襲計時器現在有一個彈出按鈕，可讓您使用一個小的可移動窗口來顯示突襲計時器。",
    ChangeLog6            = "- 將數據廣播到行會時，確定了延遲的來源。 DKP歷史記錄選項卡已從一次生成50個條目減少到了5個（使用按鈕可進一步擴展該視圖）。",
    ChangeLog7            = "- 您的本地化不正確嗎？請訪問https://www.curseforge.com/wow/addons/monolith-dkp/localization/以幫助提供適當的翻譯！",
    ChangeLog8            = "",
    ChangeLog9            = "",
    ChangeLog10           = "",
  }

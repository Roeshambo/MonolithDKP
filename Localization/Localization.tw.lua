if GetLocale() == "zhTW" then
  ...
  core.L = {
    ...
    AUTOAWARD             = "汽車獎DKP",
    AUTOAWARDTTDESC       = "殺死老闆時自動獎勵Boss Kill Bonus DKP（在“選項”選項卡中設置）。",
    AWARDBONUS            = "獎勵獎金",
    ...
    CHANGELOG1            = "- 其他優化措施可減少廣播延遲。",
    CHANGELOG2            = "- 優化的DKP調整可大大減少執行時間。",
    CHANGELOG3            = "- 過濾器現在可以與所有列表視圖（襲擊，支持，核心）一起正常使用",
    CHANGELOG4            = "- 在“ DKP歷史記錄”選項卡中添加了過濾器下拉列表，以查看個人的完整DKP歷史記錄。",
    CHANGELOG5            = "- 修復了！dkp命令，該命令在僅發送！dkp時無法正確搜索用戶的問題。",
    CHANGELOG6            = "- 在“ DKP模式”窗口中添加了“待機選擇加入”選項。處於活躍狀態時，首領被殺死後，突襲首領將向公會宣布，未參加突襲的任何人都可以有2分鐘的時間選擇等待。不在空襲中的玩家將在GUILD聊天中使用！standby（或備用名稱，如果是！standby NAME）來加入。此備用列表在每次殺死首領時都會清除。這是為了僅獎勵那些當前處於活動狀態的備用設備。",
    CHANGELOG7            = "- 在“ DKP模式”窗口中添加了“自動獎勵DKP”選項。老闆被殺死後，這將自動獎勵整個團隊（和待機，如果在同一“模式”窗口中選擇）。如果啟用了“待機選擇加入”，它將立即授予突襲，並在每個首領2分鐘的“選擇加入”窗口到期後授予待機列表中的成員。只有突襲首領會分配分數。如果突襲首領沒有此附加組件，則不會傳播任何積分。這是為了防止多名官員應用獎金。",
    CHANGELOG8            = "",
    CHANGELOG9            = "",
    CHANGELOG10           = "",
  }

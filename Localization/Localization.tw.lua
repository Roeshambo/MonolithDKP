if GetLocale() == "zhTW" then
  ...
  core.ZoneList = {
    "熔火之心", "黑翼之巢", "安其拉神廟", "納克薩瑪斯", "祖爾格拉布", "安琪拉遺址", "奧妮西亞的巢穴", "世界首領",
  }
  ...
  core.L = {
    ...
    ADDTOMAXROLL = "添加到最大擲骰",
    ADDTOMAXROLLTTDESC = "將預定值添加到最大擲骰。",
    ...
    ADJUSTDKP = "調整 DKP",
    ADJUSTDKPTTDESC = "將以上條目應用於DKP表中選定的所有玩家。",
    ...
    ANNOUNCEBID = "宣布最高出價",
    ANNOUNCEBIDTTDESC = "每次新出價者出價最高時，您都會以新的高出價團隊",
    ANTISNIPE = "反狙擊",
    ANTISNIPETTDESC = "當出價計時器低於10秒時，如果收到出價，您希望延長出價計時器的秒數。 （以防止最後一秒的狙擊）",
    ANTISNIPETTWARN = "設置為0以關閉反竊聽。",
    APPDECAYTTDESC = "您希望以每週衰减的管道减少DKP條目的DKP量。這應該是一個正數。如果未在下面選擇“僅選定玩家”，則它將應用於所有條目。",
    ...
    AUTOAWARD = "汽車獎DKP",
    AUTOAWARDTTDESC = "殺死首領時自動獎勵Boss Kill Bonus DKP（在“選項”選項卡中設置）。 只有團隊首領會以此分配分數。",
    AUTOCOMBATLOG = "自動戰鬥記錄",
    AUTOCOMBATLOGTTDESC = "在團隊中進入團隊區域或在遭遇團隊時進入戰鬥時自動啟動/ combatlog。",
    AUTOCOMBATLOGTTWARN = "如果尚未啟動“高級戰鬥日誌”，則仍必須在系統>網絡中手動啟動它。",
    AUTOOPEN = "自動打開出價窗口",
    ...
    AWARDINTERVALTTWARN = "輸入60將在每小時上方的“獎勵”欄位中獎勵RAID（和待機，如果在下面選中的話）DKP。",
    AWARDITEM = "獎勵項目",
    AWARDITEMTO = "獎勵項目",
    ...
    BEGINSYNC = "同步DKP表",
    BELT = "帶",
    BESTPRACTICES = "由於同步系統反復出現問題，舊的廣播系統有了一些改進。 2.1.0與早期版本不兼容，所有入侵者必須在2.1.0或更高版本上。 通過單擊DKP主界面左下角的狀態指示器，人員可以使用新的廣播UI。 如果您的表由於2.0.x的遷移問題而損壞，則幹部還可以使用修復選項。 您可以通過“詛咒”頁面上鍊接的YouTube視頻查看如何使用它。",
    BID = "出價",
    ...
    BOSSKILLBONUSTTDESC = "殺死首領可獲得的獎金。",
    BRACERS = "護腕",
    BROADCASTBIDS = "廣播競標",
    BROADCASTBIDSTTDESC = "啟動後，團隊中的每個人都將在其出價界面中看到所有提交的出價。如果您不希望玩家看到所有人的出價，則將其關閉。",
    ...
    CASTERDPS = "腳輪DPS",
    CHANGEDGUILDS = "看來您已經加入了新的公會。 先前公會中的所有數據已被刪除，以防止數據損壞。",
    CHEST = "胸部",
    CLASS = "職業",
    CLASSFILTER = "類過濾器",
    CLEARBIDWINDOW = "清除視窗",
    CLEARBIDWINDOWTTDESC = "從窗口清除所有項目資訊和已提交的投標。",
    CLEARSTANDBY = "清除備用​​清單",
    CLICKQUERYGUILD = "單擊啟動廣播UI。 這還將從所有在線播放器中獲取專業化和角色資訊。",
    CLOAK = "披風",
    CLOSE = "關",
    CLOSEDBIDINPROGRESS = "投標窗口已關閉，正在進行投標！輸入/ dkp bid以重新打開當前的出價會話。",
    COMMANDCHANNELS = "命令頻道",
    COMMANDCHANNELSTTDESC = "選擇要打開的頻道，以接收！bid和！dkp命令。您可以選擇三個的任意組合打開。無論頻道是什麼，所有收到的命令都會以低聲回應。",
    CONFAWARD = "確認獎項",
    CONFIRM = "確認",
    ...
    CONFIRMWHITELIST = "您確定要將選定的成員添加到白名單中嗎？",
    ...
    CREATERAIDTIMER = "創建Raid計時器（僅限幹部）（例如/ dkp計時器120 Pizza Break！）",
    CURRENTLYHAS = "目前有",
    ...
    DISTRIBUTEDKP = "分發DKP",
    DISTRUBUTEBANKED = "在當前首領的掠奪完成後，將銀行化DKP平均分配給所有團隊成員。",
    DKP = "DKP",
    DKPADJUST = "DKP調整",
    DKPADJUSTBY = "DKP調整人",
    DKPAVAILABLE = "提供DKP",
    DKPAWARDHELP = "手動獎勵項目（僅限幹部）",
    DKPBROADCASTED = "廣播的DKP數據庫",
    DKPCMDHELP = "返回當前的DKP（或<玩家名稱>的DKP）",
    DKPDATAUPDATEDBY = "DKP數據庫更新者",
    DKPENTRIESBY = "DKP條目依據",
    DKPEXPORTHELP = "打開窗口，將所有DKP資訊導出為HTML，CSV或XML。 （更多的導出實現方式將會出現）",
    ...
    FIRSTKILL = "第一次擊殺",
    FOR = "對於",
    FORBACKSLOT = "用於背部插槽物品。",
    FORCHESTSLOT = "用於胸部插槽物品。",
    FORFEETSLOT = "用於腳插槽物品。",
    FORFINGERSLOT = "用於手指插槽物品。",
    FORHANDSLOT = "用於手插槽物品。",
    FORHEADSLOT = "用於頭部插槽物品。",
    FORLEGSLOT = "用於腿部插槽物品。",
    FORNECKSLOT = "用於頸部插槽物品。",
    FOROFFHANDSLOT = "用於副手插槽物品（盾牌，施法者副手）。",
    FORONEHANDSLOT = "用於單手武器插槽物品。",
    FOROTHERSLOT = "適用於所有其他不屬於上述類別的物品（頭部，心臟，獵人之葉等​​）",
    FORPLAYERS = "對於以下玩家",
    FORRANGESLOT = "用於遠程插槽物品（弓，槍，魔杖，遺物）。",
    FORREASON = "有原因的",
    FORSHOULDERSLOT = "用於肩部插槽物品。",
    FORTRINKETSLOT = "用於飾品插槽物品。",
    FORTWOHANDSLOT = "用於雙手武器插槽物品。",
    FORWAISTSLOT = "用於腰部插槽物品。",
    FORWRISTSLOT = "用於手腕插槽物品。",
    FROMSTANDBYLIST = "從待機列表",
    GENDKPHIST = "生成DKP歷史記錄",
    GENDKPTABLE = "生成DKP表",
    GENLOOTHIST = "生成戰利品歷史",
    GIVEENDBONUS = "年終獎",
    GIVEENDBONUSTTDESC = "選擇此選項將在您結束RAID時為RAID中的每個人（以及待機狀態，如果在下面選擇）授予“RAID完成”獎勵。",
    GIVEONTIMEBONUS = "按時發放獎金",
    GIVEONTIMETTDESC = "選擇此選項將在初始化RAID時為RAID中的每個人（以及待機狀態，如果在下面選擇）授予“按時”獎勵。",
    GUILD = "公會",
    HANDS = "手",
    HEAD = "頭",
    HEALER = "治癒者",
    ...
    INCLUDESBYTTDESC = "自動獎勵上面啟動的Boss Kill DKP時，將待機列表中的玩家包括在內。",
    INCLUDESBYTTWARN = "如果啟用了“待機選擇加入”，則立即將DKP授予團隊，而待機列表授予將延遲到“選擇加入”兩分鐘窗口到期之後。",
    INCLUDESTANDBY = "包括備用",
    INCLUDESTANDBYLIST = "包括備用清單",
    INCLUDESTANDBYTTDESC = "選擇此選項將在所有自動DKP分發版中包括備用清單。",
    INCLUDESTANDBYTTWARN = "通過在DKP表中選擇不在RAID中的玩家創建待機清單，按右鍵>管理待機清單>將所選玩家添加到待機清單。",
    ...
    INITRAIDTTWARN = "這是廣播給所有突擊隊員的。每個幹部都有一個計時器，但只有突擊隊長會授予獎勵。如果某個事件（離線、重新加載等）導致領隊遺失計時器，請將RAID領隊交給另一個仍在運行計時器的幹部，以防止中斷。",
    INPARTYRAID = "在隊伍/團隊中",
    INTEGER = "整數",
    INTERVAL = "間隔",
    INVALIDBOSSNAME = "首領名稱無效",
    ...
    INVALIDROLLPARAM = "您設置了無效的擲骰參數。請修改您的設置。",
    INVALIDROLLRANGE = "您設置了無效的擲骰範圍。請修改您的設置。",
    INVALIDTARGETPLAYER = "無法獎勵物品。無效的目標玩家",
    INVALIDTIMER = "無效的計時器",
    INVITE = "邀請",
    INVITESELECTED = "邀請參加團隊",
    INZONEONLY = "在同一區域",
    INZONEONLYTTDESC = "這只會將團隊DKP獎勵給與您位於同一區域的玩家。 （用於自動獎勵，團隊計時器和零和分配）",
    ITEM = "項目",
    ITEMCOST = "物品成本",
    ...
    MAXIMUMROLL = "最大擲骰",
    MAXIMUMROLLTTDESC = "設置要使用的最大擲骰數。保留空白可使用玩家最大DKP作為最大擲骰數。",
    ...
    Ex：|cffa335ee|Hitem:16865::::::::120:577::::::|h[Breastplate of Might]|h|r下降，且最低出價為50 DKP。每個想要的玩家都通過一個打開的頻道（在下面選擇）發送“！bid 50”（或更高），而不超過其可用的DKP（除非啟動了低於零的DKP）。出價最高的玩家將獲勝，並被收取最低DKP值或第二高出價者提交的值。閱讀工具提示以獲取更多資訊。]=],
    ...
    NECK = "頸部",
    NEWBOSSKILLBONUS = "新首領擊殺獎勵",
    NEWBOSSKILLTTDESC = "升級團隊期間首次上司殺死的獎勵。",
    NEWHIGHBID = "新的最高出價是",
    ...
    NOTANOFFICER = "不是幹部。您只能在行會設置中添加具有“編輯主管注意”權限的等級。",
    ...
    ONLINE = "線上",
    ONLINEONLY = "僅在線",
    ONLINEONLYTTDESC = "這只會將團隊DKP獎勵給在線玩家。 （用於自動獎勵，團隊計時器和零和分配）",
    ONLYONEROLLWARN = "只能接受一擲骰！",
    ONLYPARTYRAID = "只有隊伍或團隊",
    ONTIMEBONUS = "準時獎金",
    ONTIMEBONUSTTDESC = "獎金，因為準時出席。",
    OODDKPHISTORYDELETE = "試圖從過期的DKP歷史記錄表中删除項。這會對你的DKP表造成不可挽回的傷害。你願意接受嗎？",
    OODDKPHISTORYENTRY = "已廣播來自過期的DKP歷史表的條目。這會對你的DKP歷史表造成不可挽回的傷害。你願意接受嗎？",
    OODDKPHISTORYTABLE = "已廣播過時的DKP歷史表。這會對你的DKP歷史表造成不可挽回的傷害。你願意接受嗎？",
    OODDKPTABLEBROADCAST = "廣播了一個過時的dkp表。這會對你的DKP表造成不可挽回的傷害。你願意接受嗎？",
    OODLOGSYNC = "廣播了一個過時的戰利品歷史表。這會對你的戰利品歷史表造成不可逆轉的傷害。你願意接受嗎？",
    OODLOOTHISTORYDELETE = "已從過時的戰利品歷史記錄表中删除項目。這可能會導致删除表中的錯誤項。你願意接受嗎？",
    OODLOOTTABLEITEM = "試圖從過期的戰利品表更新項目。這會對你的DKP表造成不可挽回的傷害。你願意接受嗎？",
    OPENAUCWINHELP = "打開帶有鏈接項目的拍賣窗口（僅限幹部）",
    ...
    OUTDATEMODIFYWARN = [=[您正試圖修改過時的dkp表。這可能會無意中損壞具有最新表的幹部的數據。
    ...
    POINTS = "點數",
    POINTSTTDESC = "在DKP表中輸入分配給選定玩家的DKP數量。預設值可以在下面的“選項”選項卡中更改。",
    ...
    RAIDTIMER = "RAID計時器",
    RAIDTIMERBONUSCONFIRM = "您確定要將準時獎金應用於此團隊嗎？",
    ...
    REASONTTWARN = "當一個首領被殺，合適的區域和首領會自動為你選擇。",
    REASSIGNED = "重新分配",
    ...
    REQUESTTABLESOFFICER = "向幹部索要更新的表格。",
    ...
    ROLE = "角色",
    ROLL = "滾",
    ROLLBIDDINGHEAD = "基於擲骰的出價",
    ROLLDECLINED = "擲骰拒絕。預期的擲骰範圍是",
    ROLLDESCRIPTION = "使用基於擲骰的出價，您可以使用多個參數選項。您可以在下面選擇計劃使用的擲骰類型。您設置的選項將不會成為接受或拒絕擲骰的參數。而是會在出價窗口中顯示預期的擲骰值以供審核。您可以右鍵單擊其擲骰條，如果擲骰條不符合正確的參數，則將其刪除。",
    ROLLFOR = "爭取",
    ...
    SELPLAYERSTTDESC = "將上述dkp衰减應用於dkp表上的|cffff000只有|r選定玩家",
    SELPLAYERSTTWARN = "對超過閾值的玩家應用衰减很有用。",
    SENDWHITELIST = "發送白名單",
    SENDWHITELISTTTDESC = "向所有人員廣播您的白名單。",
    SENDWHITELISTTTWARN = "建議您在所有人員都在線時執行此操作。如果某位幹部沒有收到此白名單，則他們將具有全部幹部權限。但是，他們將無法將其資訊廣播給其他人員。如果他們嘗試，您將收到通知。如果您收到該通知，則發送白名單及其權限將被刪除。",
    SETWHITELIST = "設定白名單",
    SETWHITELISTTTDESC1 = "將DKP表中的選定人員添加到白名單中。白名單用於|cffff0000限制|r有權修改DKP值的人員。",
    SETWHITELISTTTDESC2 = "在未選擇任何玩家的情況下使用此選項將清除您的白名單。",
    SETWHITELISTTTWARN = "只有幹部才能被列入白名單。此選項專門用於限制在此插件中哪些幹部具有幹部權限。如果您希望所有幹部都獲得許可，請將白名單留空。",
    SHADOW = "暗影",
    SHOULDERS = "護肩",
    ...
    STANDBYOPTINTTDESC = "在首領被殺後要求公會人員通過在公會聊天中輸入！standby或！standby NAME（如果是alt的話）來選擇加入公會。選擇參加會議將保持開放狀態兩分鐘。在宣布殺死每個首領之後，將清除備用清單。",
    STANDBYOPTINTTWARN = "如果啟用了“主動消滅首領”的DKP自動分發功能，則在兩分鐘的選擇加入計時器到期時，將自動進行備用列表的分發。",
    ...
    Ex：|cffa335ee|Hitem:19143::::::::120:577::::::|h[Flameguard Gauntlets]|h|r下降，靜態值為50 DKP。每個想要的玩家都通過一個打開的頻道（在下面選擇）使用"！bid "。具有最高可用DKP的播放器獲勝，並收取該靜態值。閱讀工具提示以獲取更多資訊。]=],
    ...
    TIMERWARNING = "警告：請確保您的DKP獎金參數設置正確。這些值可以在上面的“間隔”和“獎金”框中設定，也可以在下面的“選項”選項卡中設定所有“默認DKP獎勵值”。建議您設定這些值，並在使用之前通過“DKP模式”視窗（可使用“/DKP模式”或“選項”選項卡中的按鈕訪問）將其廣播給所有幹部。",
    TO = "至",
    TOBID = "投標",
    ...
    UNAUTHUPDATE2 = "嘗試廣播修改過的表格。他不是您公會的指定幹部。",
    UNEXCUSEDABSENCE = "無故缺席",
    UNEXCUSEDTTDESC = "對團隊無故缺席的處罰。",
    UNEXCUSEDTTWARN = "應為負數。",
    UPDATING = "更新中： ",
    UPTODATE = "最新",
    USE = "採用",
    USEPERCENTAGE = "使用百分比",
    USEPERCFORROLLS = "使用擲骰百分比",
    ...
    WARNING = "警告",
    WEEKLYDECAY = "周衰减",
    WEEKLYDECAYTTDESC = "您希望以每週衰减的管道减少DKP條目的DKP量。這應該是一個正數。如果未在下面選擇“僅選定玩家”，則它將應用於所有條目。",
    ...
    強烈建議您僅在希望限制哪些幹部需要權限的情況下才使用此白名單設置。如果您希望所有人員都具有權限，請完全忽略此設置功能。請謹慎使用。 （如果應用這些設置會導致問題，請使用文本編輯器打開 \WTF\Accounts\ACCOUNT_NAME\SavedVariables\MonolithDKP.lua文件，然後刪除底部附近的MonDKP_Whitelist表。）]=],
    WIPETABLES = "刪除表格",
    WIPETABLESCONF = "您確定要刪除所有表格嗎？ 當某位人員在線時，您可以從其獲取所有資訊。",
    WIPETABLESTTDESC = "刪除所有數據，包括DKP表，戰利品歷史記錄和DKP歷史記錄。 如果在嘗試同步以從可用人員接收新的和完整的資訊時發生問題，請使用此選項。",
    WITH = "與",
    WON = "贏",
    WONBY = "贏了",
    YES = "是",
    YOUCURRENTLYHAVE = "您目前擁有",
    YOUHAVERECOVERED = "您已經恢復了一名成員。請重新加載您的界面以重新計算值。",
    YOUMUSTWAIT = "你必須等著",
    YOURBID = "您的競標",
    YOURBIDOF = "您的出價",
    YOURTABLESARECURR = "您的表格目前",
    ZEROSUMBALANCE = "零和餘額",
    ZEROSUMBALANCETTDESC = "購買戰利品後，自動累積所有由團隊者花費的DKP，以進行分發。",
    ZEROSUMBANK = "零和銀行",
    ...
    EX：|cffa335ee|Hitem:18824::::::::120:577::::::|h[Magma Tempered Boots]|h|r滴和 的靜態費用為30 DKP。 玩家A通過擁有最多的DKP（或由平局領導酌情分配（如果平局）分配）來贏得競標，並且其DKP減少30。然後，每個團隊成員獲得0.75 DKP。]=],
    ZEROSUMHEAD = "零和",
    ...
    FULLBROADCASTTTWARN   = "如果接收方擁有您沒有的團隊數據，它將丟失。",
    ...
    CHANGELOG4            = "-幹部可以使用表格維修功能。要使用它，請觀看“詛咒”頁面上鍊接的視頻或轉到https://www.youtube.com/watch?v=dwnNnppFF2I。建議只有一名幹部在數據最準確的表格上使用它，然後將修復後的數據完整廣播到其他行會或幹部，以便傳遞。事先備份您保存的變量文件。",
    CHANGELOG5            = "-團隊期間的廣播條目仍將保持即時狀態，就像在2.0中一樣。由於擔心會覆蓋數據，因此無需等待廣播條目。",
    CHANGELOG6            = "-現在，決定您的表是否過時的種子會在插件中自然傳播（不再有GM公共註釋）",
    CHANGELOG7            = "-這種新的數據結構與www.warcraftdkp.com上的當前數據管理不兼容，除非那裡的開發人員能夠更新邏輯。",
    CHANGELOG8            = "-上下文菜單中可供人員使用的“驗證表”選項。這將根據他們的歷史記錄重建所有成員的DKP表（dkp，獲得和使用的終生）。建議您在運行之前備份保存的變量文件，因為如果缺少任何歷史記錄條目，該文件可能會返回不正確的值。重置播放器的所有先前DKP值（上下文菜單>全選>重置先前的dkp）將使您確切地看到每個播放器DKP從驗證中更改了多少。",
    CHANGELOG9            = "",
    CHANGELOG10           = "",
  }
end
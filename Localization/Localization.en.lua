...
core.L = {
  ...
  CUSTOMAXNBID          = "Custom Maximum Bid",
  CUSTOMAXNBIDTTDESC    = "You have set a custom maximum bid for this item. Uncheck this box to use the standard bid for this item type (set in Options tab).",
  CUSTOMAXNBIDTTWARN    = "Starting bid with this unchecked will delete the custom maximum bid value from the database.",
  DAY                   = "day",
  DAYS                  = "days",
  ...
  MAXIMUMBID            = "Maximum Bid",
  MAXGTMIN              = "Maxium value must be >= minimum or 0!",

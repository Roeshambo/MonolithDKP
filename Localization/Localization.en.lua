...
core.L = {
  ...
  ChangeLog2            = "- Added dropdown to center column of DKP table with the options to display rank, class, or spec. This column is still sortable by the selected data (class and rank only)",
  ChangeLog3            = "- Querying table status (clicking status indicator on the bottom left) will also return each players spec for use with the Spec drop down. Each player must have v1.5.2 or later for it to work.",

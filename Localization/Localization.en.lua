...
core.L = {
  ...
  CREATEDMAINTAIN = "created by Roeshambo and maintained by",
  ...
  CommDKPSCALESIZETTDESC = "Scale of the Monolith DKP window. Click \"Save Settings\" to change size to set value.",

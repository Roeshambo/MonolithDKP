...
core.L = {
  ...
  CHANGELOG1 = "Laughing Jester Tavern - Monolith DKP Edition - 2.2.5",
  CHANGELOG2 = "",
  CHANGELOG3 = "",
  CHANGELOG4 = "Laughing Jester Tavern - Monolith DKP Edition - 2.2.4",
  CHANGELOG5 = "  -Fixed the Disenchants sorting column on the Pricing tab",
  CHANGELOG6 = "",
  CHANGELOG7 = "Laughing Jester Tavern - Monolith DKP Edition - 2.2.3",
  CHANGELOG8 = "  -Added Disenchant functionality per LJT rules and added a column to Pricing tab",
  CHANGELOG9 = "",
  CHANGELOG10 = "",
}
...
core.L = {
  ...
  CHANGELOG1 = "Versioning changed to v1.3.6 for SEMVER compatibility",
  CHANGELOG2 = "Fix for invalid items shown in bid",
  CHANGELOG3 = "Fix for -0 display on 0 dkp award",
  CHANGELOG4 = "Reduce number of info requests on user login (reduces login lag)",
  CHANGELOG5 = "Guild Master Access Control List management improvements",
  CHANGELOG6 = "Quality of Life",
  CHANGELOG7 = "",
  CHANGELOG8 = "",
  CHANGELOG9 = "",
  CHANGELOG10 = "",

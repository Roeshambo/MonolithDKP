...
core.L = {
  ...
  BELT                  = "Belt",
  BESTPRACTICES         = "All players are required to run 2.0.3 or higher. Older versions are not compatible and will not receive data. If you are a non-officer and updating from 1.6, all tables will be wiped. You'll receive a sync from an officer once they have completed the migration process.",
  BID                   = "Bid",
  ...
  TOPLAYERTTDESC        = "Whispers below selection to individual players.",

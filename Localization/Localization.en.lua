...
core.L = {
  ...
  CHANGELOG1            = "- Added search box to main GUI. Searches and returns results found in name, class, spec, rank and role.",
  CHANGELOG2            = "- Table now sortable by spec as well as others.",
  CHANGELOG3            = "- Improved shift/ctrl click functionality to allow more versatility and a more natural feel. Shift+Click will now select all between your last selection and the new selection. Ctrl/Cmd+Click will include individual selections without dropping previous ones.",
  CHANGELOG4            = "- Raid timer will now attempt to sync with officers that do not have a timer running if one of the officers reloads or crashes. Will only work if one or more other officers are present in the raid to broadcast.",
  CHANGELOG5            = "- Raid timer now has a pop-out button allowing you to have a small movable window displaying your raid timer.",
  CHANGELOG6            = "- Identified source of lag when data was broadcasted to the guild. DKP History tab has been reduced from producing 50 entries to 5 at a time (with a button to extend that view further).",
  CHANGELOG7            = "- Is your localization incorrect? Go to https://www.curseforge.com/wow/addons/monolith-dkp/localization/ to help contribute proper translations!",
  CHANGELOG8            = "",
  CHANGELOG9            = "",
  CHANGELOG10           = "",
}
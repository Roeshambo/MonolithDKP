...
core.L = {
  ...
  CHANGELOG1 = "Versioning changed to v1.4.0 for SEMVER compatibility",
  CHANGELOG2 = "Fix for invalid items shown in bid",
  CHANGELOG3 = "[Experimental] Added /dkp loot command to display current instance loot. Prints item links in chat window.",
  CHANGELOG4 = "Minor QoL (Quality of Life) changes",
  CHANGELOG5 = "",
  CHANGELOG6 = "",
  CHANGELOG7 = "",
  CHANGELOG8 = "",

if GetLocale() == "koKR" then
  ...
  core.L = {
    ...
    NOFILTER              = "필터 없음",
    AWARDEDBY             = "수상 :",
    CLICKQUERYGUILD       = "동기화 요청을 시작하려면 클릭하십시오. 또한 모든 온라인 플레이어에서 사양 및 역할 정보를 가져옵니다.",
    YOUMUSTWAIT           = "기다려야 해",
    MORESECONDSTO         = "더 많은 초.",
    AWARDWARNING          = "수상 명령이 / dkp award [item link]로 변경되었습니다.",
    REASSIGNED            = "재 할당",
    NOOFFICERSONLINE      = "현재 온라인으로 동기화 할 임원이 없습니다.",
    ...
    CHANGEDGUILDS         = "새로운 길드에 가입 한 것 같습니다. DKP 테이블을 지우시겠습니까? 지우지 않으면 심각한 문제가 발생할 수 있습니다.",

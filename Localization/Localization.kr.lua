if GetLocale() == "koKR" then
  ...
  core.L = {
    ...
    CHANGELOG1            = "- 기본 GUI에 검색 창을 추가했습니다. 이름, 클래스, 사양, 순위 및 역할에서 찾은 결과를 검색하고 반환합니다.",
    CHANGELOG2            = "- 이제 스펙뿐만 아니라 다른 기준으로 테이블을 정렬 할 수 있습니다.",
    CHANGELOG3            = "- 보다 다양하고 자연스러운 느낌을 줄 수 있도록 개선 된 Shift / Ctrl 클릭 기능. Shift + 클릭은 이제 마지막 선택과 새 선택 사이에서 모두 선택합니다. Ctrl / Cmd + Click은 이전 선택을 삭제하지 않고 개별 선택을 포함합니다.",
    CHANGELOG4            = "- 레이드 타이머는 이제 장교 중 한 사람이 재 장전하거나 충돌 할 경우 타이머가 실행되지 않는 장교와 동기화를 시도합니다. 방송 공습에 한 명 이상의 다른 장교가있는 경우에만 작동합니다.",
    CHANGELOG5            = "- 레이드 타이머에는 이제 레이드 타이머를 표시하는 작은 이동식 창을 가질 수있는 팝업 버튼이 있습니다.",
    CHANGELOG6            = "- 길드에 데이터가 방송 될 때 확인 된 지연 원인. DKP 히스토리 탭이 한 번에 50 개의 항목을 생성하는 것에서 5로 감소되었습니다 (그보기를 더 확장하는 단추 사용).",
    CHANGELOG7            = "- 현지화가 잘못 되었습니까? 적절한 번역을 제공하려면 https://www.curseforge.com/wow/addons/monolith-dkp/localization/로 이동하십시오!",
    CHANGELOG8            = "",
    CHANGELOG9            = "",
    CHANGELOG10           = "",
  }
